function varargout=shadedErrorBar_anna(x,y,errBar,lineProps,transparent,logscale)
% slightly altered version of the original code https://de.mathworks.com/matlabcentral/fileexchange/26311-raacampbell-shadederrorbar
%
% Purpose 
...
%               image. 
% logscale - [optional, false by default] if true all values smaller than 0 will be deleted 
%           to avoid the patch disappearing when the axes are logged
% Outputs
...
if nargin<6, logscale=false; end
...
%remove smaller than 0 values if plot mode logscale is set to true
if logscale
uE(uE<=0)=10^-10;
lE(lE<=0)=10^-10;
y(y<=0)=10^-10;
